...
<div class="">
    <form action="{{url('/addFood')}}" method="post" enctype="multipart/form-data" >
        ...
        <input type="text" name='type' placeholder="Enter product name" required class="placeholder:text-yellow-900 border-2 border-yellow-500 rounded-md w-[250px] font-mono my-3 ml-[30px] py-2 pl-5 "/></br>
       
        <label>Product Name</label>
        <input type="text" name='name' placeholder="Enter product name" required class="placeholder:text-yellow-900 border-2 border-yellow-500 rounded-md w-[250px] font-mono my-3 ml-[28px] py-2 pl-5 "/></br>
       
        <label>Food Price</label>
        <input type="text" name='price' placeholder="Enter product price" required class="placeholder:text-yellow-900 border-2 border-yellow-500 rounded-md w-[250px] font-mono my-3 ml-[50px] py-2 pl-5 "/></br>
        <label>Food Image</label>
        <input type="file" name='image' placeholder="Enter product image" required class="placeholder:text-yellow-900 border-2 border-yellow-500 rounded-md w-[250px] font-mono my-3 ml-[40px] py-2 pl-5 "/></br>
      
        <label>Quantity</label>
        <input type="number" name='quantity' placeholder="Enter product quantity" required class="placeholder:text-yellow-900 border-2 border-yellow-500 rounded-md w-[250px] font-mono my-3 ml-[40px] py-2 pl-5 "/></br>
